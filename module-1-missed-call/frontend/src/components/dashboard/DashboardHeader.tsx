...
export default function DashboardHeader({ period, onPeriodChange }: {
  ...
  return (
    <div className="flex-shrink-0 bg-sx-surface border-b border-sx-border px-6 py-3">
      <div className="flex items-center justify-between">

        {/* Left — title + clinic */}
        <div>
          <div className="flex items-center gap-2.5">
            <h1 className="text-base font-bold text-white tracking-tight">AI Recovery Dashboard</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="text-right pl-3 border-l border-sx-border">
            <p className="text-xs font-mono text-white">{timeLabel}</p>
